...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 919273938;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        9 => wire__crate__api__drive__create_folder__create_drive_folder_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        10 => wire__crate__api__drive__share__create_share_link_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        11 => wire__crate__api__drive__delete__delete_drive_item_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__api__drive__download__download_drive_item_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__crate__api__drive__download_manager__download_progress_stream_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__drive__download_manager__download_queue_state_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__drive__models__download_queue_state_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__drive__download_manager__enqueue_download_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        17 => wire__crate__api__drive__upload_manager__enqueue_large_upload_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        18 => wire__crate__api__drive__upload_manager__enqueue_upload_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        19 => wire__crate__api__settings__download_concurrency__get_download_concurrency_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__settings__download_directory__get_download_directory_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        21 => wire__crate__api__drive__details__get_drive_item_details_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__crate__api__drive__info__get_drive_overview_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        23 => wire__crate__api__drive__share__get_share_capabilities_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__api__settings__theme__get_theme_follow_system_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__settings__theme__get_theme_manual_mode_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        29 => wire__crate__api__drive__list__list_drive_children_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        30 => wire__crate__api__auth__auth__load_persisted_auth_state_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        31 => wire__crate__api__drive__move_item__move_drive_item_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        32 => wire__crate__api__drive__download_manager__pause_download_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        35 => wire__crate__api__auth__auth__remove_auth_account_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        36 => wire__crate__api__drive__download_manager__remove_download_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        37 => wire__crate__api__drive__upload_manager__remove_upload_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        38 => wire__crate__api__drive__rename__rename_drive_item_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        39 => wire__crate__api__drive__download_manager__resume_download_task_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        40 => wire__crate__api__auth__auth__set_active_auth_account_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        41 => wire__crate__api__settings__download_concurrency__set_download_concurrency_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        42 => wire__crate__api__settings__download_directory__set_download_directory_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        43 => wire__crate__api__settings__theme__set_theme_follow_system_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        44 => wire__crate__api__settings__theme__set_theme_manual_mode_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        45 => wire__crate__api__auth__auth__update_auth_account_profile_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        46 => wire__crate__api__drive__upload_manager__upload_progress_stream_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        47 => wire__crate__api__drive__upload_manager__upload_queue_state_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        48 => wire__crate__api__drive__models__upload_queue_state_default_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        49 => wire__crate__api__drive__upload__upload_small_file_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
